...
mustContain(directPath, direct, 'if (activeWorkspaceTab !== "email_threads") return;');
mustContain(directPath, direct, 'void loadMatterEmailThreadPreview();');
mustContain(directPath, direct, "Unified matter email area.");
mustContain(directPath, direct, "Graph-synced messages and MailDrop-linked thread records appear here together");
