...
export default function AdminClientDetailPage({ params }: { params: Promise<{ id: string }> | { id: string } }) {
  ...
  function providerIndexedLink(field: "patient" | "provider" | "insurer" | "claim", value: any) {
    ...
    return (
      <Link href={href} style={{ color: "#00346e", fontWeight: 800, textDecoration: "none" }}>
        {label}
      </Link>
    );
  }
  ...
  return (
    <main style={pageStyle}>
      ...
      <div style={{ marginBottom: 18, display: "flex", gap: 16, flexWrap: "wrap" }}>
        <Link href="/admin/clients" style={{ color: "#00346e", fontWeight: 700, textDecoration: "none" }}>
          ← Clients
        </Link>
        <Link href="/admin" style={{ color: "#00346e", fontWeight: 700, textDecoration: "none" }}>
          Admin Home
        </Link>
        <Link href="/admin/invoices" style={{ color: "#00346e", fontWeight: 700, textDecoration: "none" }}>
          ...
          {editingField !== "notes" && (
            <div style={{ display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap" }}>
              <button
                ...
                style={{ padding: "3px 8px", borderRadius: 7, border: "1px solid #00346e", background: "#00346e", color: "#ffffff", fontSize: 12, fontWeight: 900, lineHeight: 1.1 }}
              >
                Add Note
              </button>
              <button
          ...
          notesEditorMode === "add" ? (
            <div style={{ display: "grid", gap: 10 }}>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", flexWrap: "wrap" }}>
                ...
                <button type="button" disabled={savingClient || !clientForm.notes.trim()} onClick={saveClientDefaults} style={{ padding: "7px 11px", borderRadius: 8, border: "1px solid #00346e", background: "#00346e", color: "#ffffff", fontWeight: 900 }}>
            ...
            <div style={{ display: "grid", gap: 12 }}>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", flexWrap: "wrap" }}>
                ...
                <button type="button" disabled={savingClient} onClick={saveClientDefaults} style={{ padding: "7px 11px", borderRadius: 8, border: "1px solid #00346e", background: "#00346e", color: "#ffffff", fontWeight: 900 }}>
                ...
                {sortedMatterRows.map((row: any) => {
                  ...
                  return (
                    <tr key={row.id || row.matter}>
                      <td style={tdStyle}>
                        {matterHref ? (
                          <Link href={matterHref} style={{ color: "#00346e", fontWeight: 800, textDecoration: "none" }}>
                            {row.matter}
                          </Link>
                        ) : (
                          row.matter
                      ...
                      <td style={tdStyle}>
                        {lawsuitHref ? (
                          <Link href={lawsuitHref} style={{ color: "#00346e", fontWeight: 800, textDecoration: "none" }}>
                            {row.lawsuit}
                          </Link>
                        ) : (
                          row.lawsuit
