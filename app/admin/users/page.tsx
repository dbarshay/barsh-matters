                ...
                <tr key={user.id} data-barsh-admin-users-table-row="true">
                  ...
                  <td style={{ padding: 8, borderBottom: "1px solid #e5e7eb" }}>
                    <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                      ...
                      <button data-barsh-admin-users-delete-row-button="true" type="button" onClick={() => void deleteUserFromRow(user)} disabled={adminUsersRowBusy} style={{ ...primaryButtonStyle, border: "1px solid #dc2626", background: "#dc2626", color: "#ffffff" }}>Delete</button>
                    </div>
                  </td>
                </tr>
              );
