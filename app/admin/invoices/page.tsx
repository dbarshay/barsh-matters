  ...
  return (
    <main style={pageStyle}>
      ...
      <div style={{ marginBottom: 18, display: "flex", gap: 16, flexWrap: "wrap" }}>
        <Link href="/admin/clients" style={{ color: "#00346e", fontWeight: 800, textDecoration: "none" }}>
          ← Clients
        </Link>
              ...
              {rows.map((invoice) => {
                ...
                return (
                  <tr key={invoice.id}>
                    ...
                    <td style={tdStyle}>
                      {clientId ? (
                        <Link href={`/admin/clients/${encodeURIComponent(clientId)}/invoice`} style={{ color: "#00346e", fontWeight: 900, textDecoration: "none" }}>
                          Client Invoice Page
                        </Link>
                      ) : "—"}
                    </td>
