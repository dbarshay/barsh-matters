...
const activeGroupKey =
  ...
  function renderMatterViewDocumentsPopup() {
    ...
    return (
      ...
      >
        <div onClick={(event) => event.stopPropagation()} style={{ width: "min(920px, 96vw)", maxHeight: "88vh", overflow: "hidden", border: "1px solid #00346e", borderRadius: 18, background: "#ffffff", boxShadow: "0 28px 90px rgba(15, 23, 42, 0.34)", display: "flex", flexDirection: "column" }}>
          <div data-barsh-direct-view-documents-header-standard="true" style={{ display: "grid", gridTemplateColumns: "90px minmax(0, 1fr) 90px", alignItems: "center", gap: 14, padding: "16px 20px", background: "#00346e", color: "#ffffff", textAlign: "center", borderBottom: "1px solid #00346e", borderTopLeftRadius: 18, borderTopRightRadius: 18 }}>
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              border: "1px solid #00346e",
              background: matterClioDocumentsLoading ? "#dbeafe" : "#00346e",
              color: "#ffffff",
              borderRadius: 999,
              padding: "8px 12px",
              fontWeight: 900,
...
function openClaimAmountEditDialog() {
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-end" }}>
            <button
              ...
              style={{
                ...
                padding: "7px 12px",
                border: "1px solid #00346e",
                background: emailThreadPreviewLoading ? "#f3f4f6" : "#00346e",
                color: "#ffffff",
                borderRadius: 10,
  ...
  function renderMatterEmailDeliveryPopup() {
    ...
    return (
      ...
      >
        <div onClick={(event) => event.stopPropagation()} style={{ width: "min(620px, 96vw)", maxHeight: "88vh", overflow: "hidden", border: "1px solid #00346e", borderRadius: 18, background: "#ffffff", boxShadow: "0 28px 90px rgba(15, 23, 42, 0.34)", display: "flex", flexDirection: "column" }}>
          <div style={{ padding: "16px 20px", background: "#00346e", color: "#ffffff", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, padding: "14px 20px 18px", borderTop: "1px solid #e2e8f0" }}>
            ...
            <button type="button" onClick={() => void submitEmailDeliveryDraft()} disabled={emailDeliverySending} style={{ minWidth: 150, height: 40, border: "1px solid #00346e", borderRadius: 10, background: emailDeliverySending ? "#dbeafe" : "#00346e", color: "#ffffff", fontWeight: 950, cursor: emailDeliverySending ? "not-allowed" : "pointer" }}>{emailDeliverySending ? "Creating..." : "Create Outlook Draft"}</button>
          </div>
        </div>
      </div>
    );
          ...
          <div style={{ padding: 24, display: "grid", gap: 18 }}>
            ...
            {showSelectStep && (
              ...
              >
                ...
                <label
                  ...
                  style={{ display: "grid", gap: 8, fontSize: 12, fontWeight: 950, color: "#00346e" }}
                >
                  Document
                  <select
            ...
            {showSignerStep && selectedTemplate && (
              ...
              >
                ...
                >
                  <label style={{ display: "grid", gap: 6, fontSize: 12, fontWeight: 950, color: "#00346e" }}>
                    Signer
                    <select
...
{directFieldEditModal === "claimAmount" && (
      ...
      {directFieldEditModal === "dos" && (
        ...
        >
          ...
          >
            <h2 style={{ margin: 0, padding: "12px 14px", background: "#00346e", color: "#ffffff", textAlign: "center", fontSize: 17, fontWeight: 950, lineHeight: 1.15 }}>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: 10, padding: "14px 16px 16px", borderTop: "1px solid #e2e8f0", background: "#ffffff" }}>
              ...
              <button type="submit" disabled={directFieldEditLoading} style={{ minWidth: 118, height: 38, border: "1px solid #00346e", borderRadius: 10, background: directFieldEditLoading ? "#93c5fd" : "#00346e", color: "#ffffff", fontWeight: 900, cursor: directFieldEditLoading ? "not-allowed" : "pointer" }}>{directFieldEditLoading ? "Saving..." : "Confirm Edit"}</button>
            </div>
          </form>
        </div>
      )}
      ...
      {(matterHydrationLoading || matterHydrationError) && (
        <div
          style={{
            ...
            color: matterHydrationError ? "#991b1b" : "#00346e",
            fontSize: 13,
            fontWeight: 650,
          }}
        >
                  ...
                  <div className="barsh-direct-summary-value barsh-direct-summary-value-strong">
                    {textValue(matter?.dateOfLoss || matter?.date_of_loss) ? (
                      <a
                        ...
                        style={{ color: "#00346e", textDecoration: "underline", textUnderlineOffset: 2 }}
                      >
                ...
                <div className="barsh-direct-summary-card">
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{ border: "1px solid #93c5fd", borderRadius: 999, background: "#eff6ff", color: "#00346e", fontSize: 11, fontWeight: 900, padding: "3px 8px", cursor: directFieldEditLoading ? "not-allowed" : "pointer" }}
                    >
                      Edit
                    </button>
                  </div>
        ...
        <section style={tabPlaceholderPanelStyle}>
          ...
          >
            ...
            <div style={{ fontWeight: 800, marginBottom: 6 }}>Settlement Inputs</div>
              <ul style={{ margin: "0 0 0 18px", padding: 0, color: "#00346e", fontSize: 13, lineHeight: 1.5 }}>
          ...
          >
            ...
            >
              <div>
                ...
                <div style={{ color: "#00346e", fontSize: 12 }}>
            ...
            >
              ...
              <div style={{ marginTop: 6, color: "#00346e", fontSize: 12 }}>
...
<table className="barsh-main-matter-table" style={{ width: "100%", borderCollapse: "collapse"  }}>
    ...
    {showMetadataModal && (
      ...
      >
        ...
        >
          <h2 style={{ margin: 0, padding: "14px 18px", background: "#00346e", color: "#ffffff", textAlign: "center", fontSize: 20, fontWeight: 950, lineHeight: 1.15 }}>
            Edit Lawsuit Metadata
          </h2>
