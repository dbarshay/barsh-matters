  ...
  try {
    ...
    return NextResponse.json({
      ...
      invoices: invoices.map((invoice: any) => ({
        ...
        baseNetRemitToProvider: moneyNumber(invoice.baseNetRemitToProvider),
        costBalanceThisRemittancePeriod: moneyNumber(invoice.costBalanceThisRemittancePeriod),
        costBalanceDeductionCap: moneyNumber(invoice.costBalanceDeductionCap),
        costBalanceAdjustmentToNetRemit: moneyNumber(invoice.costBalanceAdjustmentToNetRemit),
        costBalanceLedgerBefore: moneyNumber(invoice.costBalanceLedgerBefore),
        costBalanceLedgerChange: moneyNumber(invoice.costBalanceLedgerChange),
        costBalanceLedgerAfter: moneyNumber(invoice.costBalanceLedgerAfter),
        netRemitToProviderTotal: moneyNumber(invoice.netRemitToProviderTotal),
