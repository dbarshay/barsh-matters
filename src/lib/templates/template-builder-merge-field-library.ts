...
export const TEMPLATE_BUILDER_CANONICAL_MERGE_FIELDS: TemplateBuilderMergeFieldDefinition[] = [
...

  {
    ...
    exampleOutput: "David Barshay",
    aliases: ["patient", "patient name", "assignor"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    ...
    mergeField: "{{patient.firstName}}",
    exampleOutput: "David",
    aliases: ["patient first name"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    ...
    mergeField: "{{patient.dateOfBirth}}",
    exampleOutput: "01/01/1980",
    aliases: ["patient dob"],
    fieldType: "Date",
    compatibleModifiers: ["date:MM/DD/YYYY", "date:Month D, YYYY", "bold", "italic", "underline"],
    uiLabelEditable: true,
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Patient Hidden Street",
    mergeField: "{{patient.hidden_street}}",
    exampleOutput: "445 Broadhollow Road",
    aliases: ["patient hidden street", "hidden_street"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Patient Hidden City",
    mergeField: "{{patient.hidden_city}}",
    exampleOutput: "Melville",
    aliases: ["patient hidden city", "hidden_city"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Patient Hidden State",
    mergeField: "{{patient.hidden_state}}",
    exampleOutput: "NY",
    aliases: ["patient hidden state", "hidden_state"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Patient Hidden Zipcode",
    mergeField: "{{patient.hidden_zipcode}}",
    exampleOutput: "11747",
    aliases: ["patient hidden zipcode", "hidden_zipcode"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    ...
    exampleOutput: "ATLANTIC MEDICAL & DIAGNOSTIC, P.C.",
    aliases: ["provider", "medical provider"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Treating Provider Hidden Street",
    mergeField: "{{treatingProvider.hidden_street}}",
    exampleOutput: "445 Broadhollow Road",
    aliases: ["treating provider hidden street"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Treating Provider Hidden City",
    mergeField: "{{treatingProvider.hidden_city}}",
    exampleOutput: "Melville",
    aliases: ["treating provider hidden city"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Treating Provider Hidden State",
    mergeField: "{{treatingProvider.hidden_state}}",
    exampleOutput: "NY",
    aliases: ["treating provider hidden state"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Treating Provider Hidden Zipcode",
    mergeField: "{{treatingProvider.hidden_zipcode}}",
    exampleOutput: "11747",
    aliases: ["treating provider hidden zipcode"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Matter ID",
    mergeField: "{{matter.id}}",
    exampleOutput: "BRL_202600003",
    aliases: ["matter id"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Matter Display Number",
    mergeField: "{{matter.displayNumber}}",
    exampleOutput: "BRL_202600003",
    aliases: ["matter display number"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Matter Type",
    mergeField: "{{matter.type}}",
    exampleOutput: "Individual Matter",
    aliases: ["matter type"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
  ...
  },
  {
    ...
    mergeField: "{{matter.caseType}}",
    exampleOutput: "No-Fault",
    aliases: ["case type"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
  ...
  },
  {
    kind: "canonical",
    category: "Matter",
    fieldLabel: "Final Status",
    mergeField: "{{matter.finalStatus}}",
    exampleOutput: "Open",
    aliases: ["final status"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
  ...
  },
  {
    ...
    mergeField: "{{matter.closedReason}}",
    exampleOutput: "Closed Lawsuit",
    aliases: ["closed reason"],
    fieldType: "Text",
    compatibleModifiers: ["upper", "lower", "title", "bold", "italic", "underline"],
    uiLabelEditable: true,
    uiCategoryEditable: true,
